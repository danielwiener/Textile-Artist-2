<?php
/**
 * The displays the content for the projects page it is here only to protect against someone accidentally going to the empty projects page.
 *
 * @package WordPress
...
<?php 	 
		$project_args = array (
			'post_parent'		=> '40', //shows most recent Knitting Nation
			'orderby'			=> 'date',
			'order'				=> 'DESC',
			'posts_per_page'		=> '1',
			'post_type'			=> 'page',
