...
get_header(); ?>
		<div id="container" class="full-page">
			<div id="content" role="main">
				<!-- <div id="front-page"> -->
				     <div class="dw_wrapper"><a href="<?php bloginfo('siteurl') ?>/collections/spring-2004" title="Spring 2004"><img src="<?php bloginfo('stylesheet_directory') ?>/images/collections.jpg" width="472" height="700" /></a><div class="dw_description"><div class="dw_description_content2"><a href="/lc/collections/some_collection" title="sometitle">Collections</a></div></div></div> 
